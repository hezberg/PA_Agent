"""Order-opportunity detection and alert text (UI-agnostic parts).

The Qt alert popup / sound helpers remain in ``pa_agent.gui.order_opportunity``;
the web frontend renders the alert as a toast and plays a browser-side beep.
"""
...
def format_order_alert_message(decision: dict[str, Any]) -> str:
    """Short summary for the order-opportunity alert (toast / popup text)."""
